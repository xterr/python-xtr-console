...
class ConsoleStyle:
    ...
    def title(self, message: str) -> None:
        ...
        self._console.print()
        self._console.print(Text.from_markup(message, style="bold green"))
    ...
    def section(self, message: str) -> None:
        ...
        self._console.print()
        self._console.print(Text.from_markup(message, style="bold yellow"))
    ...
    def table(self, headers: Sequence[str], rows: Iterable[Sequence[str]]) -> None:
        ...
        table = Table(*headers, box=box.SQUARE, header_style="green")
        for row in rows:
            table.add_row(*row)
    ...
    def confirm(self, question: str, *, default: bool = True) -> bool:
        ...
        answer: bool = Confirm.ask(
            _question(question), console=self._console, default=default, stream=self._input_stream
        )
        self._end_scripted_answer()
        return answer
    ...
    def _block(self, label: str, message: str, style: str) -> None:
        self._console.print(block(label, Text.from_markup(message), style))
        self._console.print()
...
def _question(question: str) -> Text:
    return Text.from_markup(f" [green]{question}[/green]")


def _width_of(message: str) -> int:
    return max(Text.from_markup(message).cell_len, 1)
